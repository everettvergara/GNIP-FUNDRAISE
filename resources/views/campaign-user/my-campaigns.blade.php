            ...
            <div class="bg-white p-6 rounded-lg border border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    @if ($campaign->status === \App\Models\Campaign::STATUS_PENDING)
                        <p class="text-xs text-amber-700 mt-2">Awaiting admin approval — you can undo submission to make edits.</p>
                    @endif
                </div>
                <div class="flex flex-wrap gap-2">
                    ...
                    @elseif ($campaign->canBeEditedByOwner() || $campaign->status === \App\Models\Campaign::STATUS_PENDING)
